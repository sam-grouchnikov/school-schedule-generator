                ...
                div(classes = "textbox-container-steps") {
                    ...
                    div(classes= "listContainer") {
                        div(classes = "steps-table2") {
                            ...
                            div(classes = "steps-cell header font-25px") {
                            ...
                            div(classes = "steps-cell header font-25px") { +"Type" }
                            ...
                            existing.forEach {
                                ...
                                div(classes = "steps-cell monospace horalign") {
                                    div(classes = "horalign") { +it.room_capacity }
                                }
                    ...
                    div(classes = "textbox-step1-1-center") {
                        form(action = "/addSchedToDB", method = FormMethod.get) {
                            ...
                            div(classes = "steps-fontsize textaligncenter") {
                                ...
                                +"Type: "
                                unsafe {
                                    raw("<select name=\"type\" class = \"step4input\">")
                                ...
                                input(type = InputType.number, name = "periods", classes = "periods-input step4input")
